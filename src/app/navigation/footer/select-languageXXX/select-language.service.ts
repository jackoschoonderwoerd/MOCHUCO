...
export class SelectLanguageService {
    ...
    // private selectedLanguageSubject = new BehaviorSubject<LanguageData>(this.defaultLanguage)
    ...
    // return collectionData(languagesRef, { idField: 'id' }) as Observable<LanguageData[]>
}

    // getLanguage(id: string) {
        // const languageRef = doc(this.firestore, `languages/${id}`);

        // return docData(languageRef) as Observable<LanguageData>;
    // }

    // setLanguage(id: string) {
        // console.log(id);
        // this.selectedLanguageSubject.next(id)
        // const languageRef = doc(this.firestore, `languages/${id}`);
